  ...
  <div className="row">
    <div className="menu">
      <ul className="menu__logo menu__main">
        ...
        <li data-dropdown-trigger="true">
        <svg className="menu__logo-small " data-dropdown-trigger="true" xmlns="http://www.w3.org/2000/svg" width="793.428" height="749.254" viewBox="0 0 793.428 749.254">
